...
function initMap() {
  ...
  state_json.setStyle(function(feature) {
    ...
    for(var i = 0; i < state_color_arr.length; i++){
      ...
      // alert(state_color_arr[i].state_name + " " + feature.getProperty('name'));
  ...
  /*test_json = new google.maps.Data();
  test_json.loadGeoJson('test.json');
  test_json.setStyle(function(feature) {
